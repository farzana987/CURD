        ...
        <div class="row g-0">
            <div class="col-md-4">
                ...
                <form class="my-5" method="POST">
                       <div class="mb-3">
                        <label for="username" class="form-label">Eenter your name</label>
                    ...
                    <input type="submit" name="saveinfo" class="btn btn-sd btn-info" value=" Add new user" name="">
            ...
            if (isset($_GET['edit_id'])){
              ...
              ?>
                ...
                <form class="my-5" method="POST">
                    ...
                    <input type="submit" name="updateinfo" class="btn btn-sd btn-info" value=" Add new user" name="">
